...
parser.add_argument("--datadir", type=str, default="./Data/Train_Test", help='dataset directory')
parser.add_argument('--data_train', type=str, default='./Data/Train_Test/Train', help='train dataset name')
parser.add_argument('--data_test', type=str, default='./Data/Train_Test/Test', help='test dataset name')
parser.add_argument('--data_val', type=str, default='./Data/Train_Test/Val', help='test dataset name')
...
parser.add_argument('--lr_decay', type=int, default=150, help='learning rate decay per N epochs')
